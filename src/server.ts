...
import { getPrdocuts, getProduct, createProduct, updateProduct, removeProduct } from './controllers/productController';
import 'dotenv/config';


const Port = process.env.PORT;

export  const server = http.createServer((req:any, res) => {
...
const PORT:any = process.env.PORT || Port || 5000;
